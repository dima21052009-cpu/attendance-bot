...
RENDER_URL = "https://attendance-bot-nj0o.onrender.com"  # Публичный адрес вашего сервиса

# Список Telegram ID администраторов (только они могут запрашивать отчеты и очищать базу)
ADMIN_IDS = [5387945787]
...
def self_ping():
    """Фоновая функция, которая каждые 5 минут шлет запрос на собственный сайт, чтобы Render не усыплял бота"""
    while True:
        try:
